...
Complements the static `static_critic` by catching semantic and layout issues
...
The report is shaped to match `static_critic.CriticReport.to_prompt_block()` so the
...
from ppt_engine.critic.static_critic import CriticReport, Violation
from ppt_engine.llm.base import LLMProvider
from ppt_engine.llm.types import LLMMessage
