...
import type { CreatingElement, ShapeFormatPainter, TextFormatPainter } from '@pptist/types/edit'
import type { DialogForExportTypes } from '@pptist/types/export'
import { type TextAttrs, defaultRichTextAttrs } from '@pptist/utils/prosemirror/utils'
