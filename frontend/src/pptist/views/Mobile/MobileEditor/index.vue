...
import type { PPTElement } from '@pptist/types/slides'
import type { AlignmentLineProps } from '@pptist/types/edit'
import type { Mode } from '@pptist/types/mobile'
import useSlideBackgroundStyle from '@pptist/hooks/useSlideBackgroundStyle'
import useDragElement from '@pptist/views/Editor/Canvas/hooks/useDragElement'
import useScaleElement from '@pptist/views/Editor/Canvas/hooks/useScaleElement'
import useRotateElement from '@pptist/views/Editor/Canvas/hooks/useRotateElement'

import AlignmentLine from '@pptist/views/Editor/Canvas/AlignmentLine.vue'
