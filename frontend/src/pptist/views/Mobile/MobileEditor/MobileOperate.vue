...
import type { PPTElement, PPTLineElement, PPTChartElement, PPTVideoElement, PPTAudioElement } from '@pptist/types/slides'
import useCommonOperate from '@pptist/views/Editor/Canvas/hooks/useCommonOperate'
import type { OperateResizeHandlers } from '@pptist/types/edit'

import BorderLine from '@pptist/views/Editor/Canvas/Operate/BorderLine.vue'
import ResizeHandler from '@pptist/views/Editor/Canvas/Operate/ResizeHandler.vue'
import RotateHandler from '@pptist/views/Editor/Canvas/Operate/RotateHandler.vue'
