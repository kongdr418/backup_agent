...
import type { PPTElement, PPTImageElement, PPTLineElement, PPTShapeElement } from '@pptist/types/slides'
import { OperateResizeHandlers, type AlignmentLineProps, type MultiSelectRange } from '@pptist/types/edit'
import { MIN_SIZE } from '@pptist/configs/element'
import { SHAPE_PATH_FORMULAS } from '@pptist/configs/shapes'
import { type AlignLine, uniqAlignLines } from '@pptist/utils/element'
