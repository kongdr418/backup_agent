...
import { useMainStore, useSlidesStore, useKeyboardStore } from '@pptist/store'
import type { ContextmenuItem } from '@pptist/components/Contextmenu/types'
import type { PPTElement, PPTShapeElement } from '@pptist/types/slides'
import type { AlignmentLineProps, CreateCustomShapeData } from '@pptist/types/edit'
import { injectKeySlideScale } from '@pptist/types/injectKey'
import { removeAllRanges } from '@pptist/utils/selection'
