    ...
    <div class="right">
      ...
      <div class="group-menu-item">
        <div class="menu-item" v-tooltip="tr('pptist.slideshow')" @click="enterScreening()">
          <Presentation :size="16" class="icon" />
        </div>
        <Popover trigger="click" center>
          <template #content>
            <PopoverMenuItem class="popover-menu-item" @click="enterScreeningFromStart()"><Play :size="16" class="icon" /> {{ tr('pptist.fromStart') }}</PopoverMenuItem>
            <PopoverMenuItem class="popover-menu-item" @click="enterScreening()"><Presentation :size="16" class="icon" /> {{ tr('pptist.fromCurrent') }}</PopoverMenuItem>
          </template>
          <div class="arrow-btn"><ChevronDown :size="12" class="arrow" /></div>
        </Popover>
      </div>
...
import { Save, Presentation, Play, ChevronDown } from 'lucide-vue-next'
