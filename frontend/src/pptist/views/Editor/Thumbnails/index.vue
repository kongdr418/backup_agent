<template>
  ...
  >
    <div class="add-slide">
      <div class="btn" @click="createSlide()"><Plus :size="14" class="icon" />添加幻灯片</div>
    </div>
...
import { fillDigit } from '@pptist/utils/common'
import { isElementInViewport } from '@pptist/utils/element'
...
import useSectionHandler from '@pptist/hooks/useSectionHandler'
import useScreening from '@pptist/hooks/useScreening'
import useLoadSlides from '@pptist/hooks/useLoadSlides'

import { Plus } from 'lucide-vue-next'
import ThumbnailSlide from '@pptist/views/components/ThumbnailSlide/index.vue'
