...
import type { GradientType, PPTShapeElement, Gradient, ShapeText, TextInset } from '@pptist/types/slides'
import { type ShapePoolItem, SHAPE_LIST, SHAPE_PATH_FORMULAS } from '@pptist/configs/shapes'
...
import useShapeFormatPainter from '@pptist/hooks/useShapeFormatPainter'
...
import ShapeItemThumbnail from '@pptist/views/Editor/CanvasTool/ShapeItemThumbnail.vue'
import ColorButton from '@pptist/components/ColorButton.vue'
import CheckboxButton from '@pptist/components/CheckboxButton.vue'
...
import Slider from '@pptist/components/Slider.vue'
import RadioButton from '@pptist/components/RadioButton.vue'
import RadioGroup from '@pptist/components/RadioGroup.vue'
import Select from '@pptist/components/Select.vue'
import Popover from '@pptist/components/Popover.vue'
import GradientBar from '@pptist/components/GradientBar.vue'
