...
import type { Broken2LineDirection, LinePoint, LineStyleType, PPTLineElement } from '@pptist/types/slides'
import useHistorySnapshot from '@pptist/hooks/useHistorySnapshot'

import ElementShadow from '../common/ElementShadow.vue'
import SVGLine from '../common/SVGLine.vue'
import LinePointMarker from '@pptist/views/components/element/LineElement/LinePointMarker.vue'
