...
import type { PPTImageElement, SlideBackground } from '@pptist/types/slides'
import { CLIPPATHS } from '@pptist/configs/imageClip'
import useHistorySnapshot from '@pptist/hooks/useHistorySnapshot'
import useImageHandler from '@pptist/hooks/useImageHandler'
