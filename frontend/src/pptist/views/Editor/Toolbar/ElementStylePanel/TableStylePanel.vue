...
import type { PPTTableElement, TableCell, TableCellStyle, TableTheme, TextAlign, TextAlignVertical } from '@pptist/types/slides'
...
import Checkbox from '@pptist/components/Checkbox.vue'
