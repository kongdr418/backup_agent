...
import api from '@pptist/services'
import { useMainStore } from '@pptist/store'
import emitter, { EmitterEvents } from '@pptist/utils/emitter'
import { FONTS } from '@pptist/configs/font'
import useTextFormatPainter from '@pptist/hooks/useTextFormatPainter'
import message from '@pptist/utils/message'
import { htmlToText } from '@pptist/utils/common'

import TextColorButton from '@pptist/components/TextColorButton.vue'
...
import Input from '@pptist/components/Input.vue'
import Button from '@pptist/components/Button.vue'
import ButtonGroup from '@pptist/components/ButtonGroup.vue'
import Select from '@pptist/components/Select.vue'
import SelectGroup from '@pptist/components/SelectGroup.vue'
