...
import { useSlidesStore, useMainStore } from '@pptist/store'
import type { PPTElement } from '@pptist/types/slides'
import { ELEMENT_TYPE_ZH } from '@pptist/configs/element'
import useOrderElement from '@pptist/hooks/useOrderElement'
import useHideElement from '@pptist/hooks/useHideElement'
import useSelectElement from '@pptist/hooks/useSelectElement'
import useLockElement from '@pptist/hooks/useLockElement'
import { ElementOrderCommands } from '@pptist/types/edit'

import MoveablePanel from '@pptist/components/MoveablePanel.vue'
