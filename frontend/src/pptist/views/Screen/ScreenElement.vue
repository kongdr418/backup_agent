...
import ScreenVideoElement from '@pptist/views/components/element/VideoElement/ScreenVideoElement.vue'
import ScreenAudioElement from '@pptist/views/components/element/AudioElement/ScreenAudioElement.vue'
