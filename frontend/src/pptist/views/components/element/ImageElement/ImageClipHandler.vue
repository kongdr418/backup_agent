...
import { useMainStore, useKeyboardStore } from '@pptist/store'
import { KEYS } from '@pptist/configs/hotkey'
import { type ImageClipedEmitData, OperateResizeHandlers } from '@pptist/types/edit'
import type { ImageClipDataRange, ImageElementClip } from '@pptist/types/slides'
