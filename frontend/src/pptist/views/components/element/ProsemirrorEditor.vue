...
import { useKeyboardStore, useMainStore } from '@pptist/store'
import type { EditorView } from 'prosemirror-view'
import { toggleMark, wrapIn, lift } from 'prosemirror-commands'
import { initProsemirrorEditor, createDocument } from '@pptist/utils/prosemirror'
import { isActiveOfParentNodeType, findNodesWithSameMark, getTextAttrs, autoSelectAll, addMark, markActive, getFontsize } from '@pptist/utils/prosemirror/utils'
import emitter, { EmitterEvents, type RichTextAction, type RichTextCommand } from '@pptist/utils/emitter'
import { alignmentCommand } from '@pptist/utils/prosemirror/commands/setTextAlign'
import { indentCommand, textIndentCommand } from '@pptist/utils/prosemirror/commands/setTextIndent'
import { toggleList } from '@pptist/utils/prosemirror/commands/toggleList'
import { setListStyle } from '@pptist/utils/prosemirror/commands/setListStyle'
import { replaceText } from '@pptist/utils/prosemirror/commands/replaceText'
import type { TextFormatPainterKeys } from '@pptist/types/edit'
