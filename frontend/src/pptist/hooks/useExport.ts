...
import type { PPTElementOutline, PPTElementShadow, PPTElementLink, Slide } from '@pptist/types/slides'
import { getElementRange, getLineElementPath, getTableSubThemeColor } from '@pptist/utils/element'
import { type AST, toAST } from '@pptist/utils/htmlParser'
import { type SvgPoints, toPoints } from '@pptist/utils/svgPathParser'
